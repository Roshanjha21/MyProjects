...
public class WelcomeScreen {
		...
		String filename; 
		char ch; 
		File directory = new  File("C:\\\\Users\\\\ASUS\\\\Dropbox\\\\My PC (LAPTOP-811NLRVE)\\\\Desktop\\\\file handling"); 
		...
		case 1: 
					...
					try { 
					File file = new  
					File("C:\\Users\\ASUS\\Dropbox\\My PC (LAPTOP-811NLRVE)\\Desktop\\file handling\\" + filename + ".txt");
		...
		case 3: 
					...
					filename = input.next(); 
					File directory_delete = new File("C:\\Users\\ASUS\\Dropbox\\My PC (LAPTOP-811NLRVE)\\Desktop\\file handling"); 
					...
					// Linear search in the String array flist_delete containing files
					for (int i = 0; i < flist_delete.length; i++) { 
					String delete_filename = flist_delete[i]; 
					if  
					(delete_filename.equalsIgnoreCase(filename)) {
					File file = new File("C:\\Users\\ASUS\\Dropbox\\My PC (LAPTOP-811NLRVE)\\Desktop\\file handling\\" + delete_filename);
					if (file.delete()) { 
		...
		// Replace the file path with path of the directory 
					...
					filename = input.next(); 
					File directory_search = new File("C:\\Users\\ASUS\\Dropbox\\My PC (LAPTOP-811NLRVE)\\Desktop\\file handling");
...
// TODO Auto-generated method stub 
						...
						File folder = new  File("C:\\Users\\ASUS\\Dropbox\\My PC (LAPTOP-811NLRVE)\\Desktop\\file handling\\"); 
